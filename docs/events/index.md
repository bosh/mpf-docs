...
* [Multiball Events](multiballs/index.md)
    ...
    * [multiball_(name)\_restarted](multiball_multiball_restarted.md)
    * [multiball_(name)\_restart_grace_period_started](multiball_multiball_restart_grace_period_started.md)
