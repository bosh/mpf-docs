...
!!! warning "MPF 0.80 is Available"
    ...
    This installation guide is for MPF 0.57 and the legacy media controller (MPF-MC). The legacy MC is replaced in the upcoming MPF 0.80 with the Godot MC (MPF-GMC). If you are just getting started with MPF, we recommend you [install MPF 0.80](index.md) instead.

*Last updated April 13, 2023*

The latest official release of MPF is `v0.57.5`, which has substantial changes from 0.56. If you are upgrading a 0.56 project, this page will provide guidance on how to do that.

The instructions on this page are presented for reference. If instead you want to upgrade an existing project to 0.80, see [Installing MPF 0.80 and the GMC](../gmc/installation.md) and [Migrating to MPF 0.80 and Godot GMC](0.80.md) for more up-to-date information.
